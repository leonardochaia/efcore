...
ORDER BY [t].[Id]");
        ...
        public class MyContext : DbContext
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                //modelBuilder.Entity<TemporalBlog>().IsMemoryOptimized();
                ...
                modelBuilder.Entity<TemporalBlog>().Property<DateTime>("Start").HasColumnName("StartColumn");//.ValueGeneratedOnAdd();
                modelBuilder.Entity<TemporalBlog>().Property<DateTime>("End");//.ValueGeneratedOnAdd();
